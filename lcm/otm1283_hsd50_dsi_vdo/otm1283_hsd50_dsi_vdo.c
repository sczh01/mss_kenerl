...
//******2:otp_direction=1, to do add vcomoffset
//******3:otp_direction=0, to do dec vcomoffset
...
//********************************************************************************************************
extern unsigned int  otp_vcomoffset;
extern unsigned char otp_direction;
extern unsigned char otp_confirm;
//unsigned char LowPower_cmd_flag=1;
static unsigned int otp_value; // the final vcom value
static unsigned int vcom_value=0x6a;
static struct LCM_setting_table lcm_adjust_vcom[] =
{
{0xb6, 2 ,{0x6a,0x6a}},
{REGFLAG_END_OF_TABLE, 0x00, {}}
};
static void push_table_vcom(struct LCM_setting_table *table, unsigned int count, unsigned char force_update)
{
    unsigned int i;
    ...
    for(i = 0; i < count; i++)
    {
		...
		case 0xb6 :
			...
			table[i].para_list[0]=otp_value;
			table[i].para_list[1]=otp_value;
			otp_direction=0;
			otp_vcomoffset=0;
...
#ifndef BUILD_LK
printk("kevin:otp_adjust_vcom");
printk("kevin:otp_vcomoffset=%x\n",otp_vcomoffset);
#endif
   push_table_vcom(lcm_adjust_vcom, sizeof(lcm_adjust_vcom) / sizeof(struct LCM_setting_table), 1); 
#ifndef BUILD_LK
printk("kevin:otp_vcomoffset=%x\n",otp_value);
#endif
}
...
//we will do below sentence after pick down menu key
//********************************************************************************************
void otp_confirm_vcom(void)
{
...
//********************************************************************************************************
//******1:lcm_debug_online  setting
//******2:otp_confirm_vcom  setting
//********************************************************************************************************
...
static unsigned int lcm_esd_recover(void)
{
	...
	if(otp_confirm==0xff)
	{
	otp_confirm_vcom();  //this is for confirm ok key
	otp_confirm=0;
	}

	lcm_debug_online();  //this is for debug online
...
LCM_DRIVER otm1283_hsd50_dsi_vdo_lcm_drv = 
{
    .name			= "otm1283_hsd50_dsi_vdo",
