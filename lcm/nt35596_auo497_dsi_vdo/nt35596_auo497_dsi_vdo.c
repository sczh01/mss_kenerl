...
//		params->dsi.CLK_TRAIL = 10;
		...
		params->dsi.fbk_div =41; // 72; // 58;//34; // 19;0x12    // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)	
...
LCM_DRIVER nt35596_auo497_dsi_vdo_lcm_drv = 
{
    .name			= "nt35596_auo497_dsi_vdo",
