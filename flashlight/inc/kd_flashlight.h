...
//yxh-20140424
#define FLASH_IOC_TURN_ON_IRDA_LIGHT _IOR(FLASHLIGHT_MAGIC, 120, int)
#define FLASH_IOC_TURN_OFF_IRDA_LIGHT _IOR(FLASHLIGHT_MAGIC, 121, int)
#define FLASH_IOC_TURN_ON_IRDA_FILTER_LEN _IOR(FLASHLIGHT_MAGIC, 122, int)
#define FLASH_IOC_TURN_OFF_IRDA_FILTER_LEN _IOR(FLASHLIGHT_MAGIC, 123, int)
