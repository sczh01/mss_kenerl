...
#define HW_CTL_IO_POWER_ON_EN_NTF	_IO('H', 0x0F)
#define HW_CTL_IO_POWER_ON_DIS_NTF	_IO('H', 0x10)
#define HW_CTL_IO_STANDBY_EN_NTF	_IO('H', 0x11)
#define HW_CTL_IO_STANDBY_DIS_NTF	_IO('H', 0x12)
#define HW_CTL_IO_VIDEO_RECORD_EN_NTF	_IO('H', 0x13)
#define HW_CTL_IO_VIDEO_RECORD_DIS_NTF	_IO('H', 0x14)
