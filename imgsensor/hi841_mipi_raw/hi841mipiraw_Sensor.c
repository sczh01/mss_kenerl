...
{	
	HI841DB("HI841PreviewSetting_2lane_30fps:\n ");
	...
	// MIPI Setting
HI841_write_cmos_sensor(0x0800, 0x57);  // tclk_post
HI841_write_cmos_sensor(0x0801, 0x1F);  // ths_prepare
HI841_write_cmos_sensor(0x0802, 0x37);  // ths_zero_min
HI841_write_cmos_sensor(0x0803, 0x27);  // ths_trail
HI841_write_cmos_sensor(0x0804, 0x1F);  // tclk_trail_min
HI841_write_cmos_sensor(0x0805, 0x17);  // tclk_prepare
HI841_write_cmos_sensor(0x0806, 0x87);  // tclk_zero
HI841_write_cmos_sensor(0x0807, 0x1F);  // tlpx
...
HI841_write_cmos_sensor(0x0387	,0x03);  //	y_odd_inc 
    ...
    HI841DB("HI841PreviewSetting_2lane exit :\n ");
}
...
HI841_write_cmos_sensor(0x0341,0xC0);  //	frame_length_lines_Lo
...
HI841_write_cmos_sensor(0x0342, 0x0E); // line_length_pck_Hi
HI841_write_cmos_sensor(0x0343, 0x90); // line_length_pck_Lo

HI841_write_cmos_sensor(0x0344, 0x00); // x_addr_start_Hi
HI841_write_cmos_sensor(0x0345, 0x14); // x_addr_start_Lo (20, Display시에 20-23 은 잘리고 24 부터 출력)
HI841_write_cmos_sensor(0x0346, 0x00); // y_addr_start_Hi
HI841_write_cmos_sensor(0x0347, 0x16); // y_addr_start_Lo (22, Display시에 22-23 은 잘리고 24 부터 출력)
HI841_write_cmos_sensor(0x0348, 0x0C); // x_addr_end_Hi
HI841_write_cmos_sensor(0x0349, 0xFB); // x_addr_end_Lo (3323, Display시에 3320-3323 은 잘림)
HI841_write_cmos_sensor(0x034A, 0x09); // y_addr_end_Hi
HI841_write_cmos_sensor(0x034B, 0xC9); // y_addr_end_Lo (2505, Display시에 2504-2505 은 잘림)
...
HI841_write_cmos_sensor(0x4002, 0x00);  // tg_ctl3 
...
HI841_write_cmos_sensor(0x4100, 0x00);  // 
HI841_write_cmos_sensor(0x4101, 0xF0);  // 
...
HI841_write_cmos_sensor(0x405B, 0xBB);  // dcdc_ctl4 (NCP control)
...
HI841_write_cmos_sensor(0x0307, 0x41);  // pll multiplier
...
HI841_write_cmos_sensor(0x4131, 0x3E);  // ramp_poffset_n_pos_Lo *
HI841_write_cmos_sensor(0x4132, 0x00);  // ramp_poffset_n_neg_Hi *
HI841_write_cmos_sensor(0x4133, 0xE6);  // ramp_poffset_n_neg_Lo *
HI841_write_cmos_sensor(0x4134, 0x03);  // ramp_sig_ofs_ful_neg_Hi *
HI841_write_cmos_sensor(0x4135, 0x98);  // ramp_sig_ofs_ful_neg_Lo *

HI841_write_cmos_sensor(0x4136, 0x00);  // col_rst_time_flag_pos_Hi  *
HI841_write_cmos_sensor(0x4137, 0x3E);  // col_rst_time_flag_pos_Lo  *
HI841_write_cmos_sensor(0x4138, 0x00);  // col_rst_time_flag_neg_Hi  *
HI841_write_cmos_sensor(0x4139, 0xE6);  // col_rst_time_flag_neg_Lo  *

HI841_write_cmos_sensor(0x410E, 0x00);  // ramp_clk_msk1_ful_neg_Hi *
HI841_write_cmos_sensor(0x410F, 0x52);  // ramp_clk_msk1_ful_neg_Lo *
HI841_write_cmos_sensor(0x410C, 0x00);  // ramp_clk_msk1_ful_pos_Hi *
HI841_write_cmos_sensor(0x410D, 0xE4);  // ramp_clk_msk1_ful_pos_Lo *

HI841_write_cmos_sensor(0x4112, 0x01);  // ramp_clk_msk2_ful_neg_Hi *
HI841_write_cmos_sensor(0x4113, 0x2E);  // ramp_clk_msk2_ful_neg_Lo *
HI841_write_cmos_sensor(0x4110, 0x03);  // ramp_clk_msk2_ful_pos_Hi *
HI841_write_cmos_sensor(0x4111, 0x96);  // ramp_clk_msk2_ful_pos_Lo *

HI841_write_cmos_sensor(0x4106, 0x00);  // ramp_preset1_ful_neg_Hi *
HI841_write_cmos_sensor(0x4107, 0x52);  // ramp_preset1_ful_neg_Lo *
HI841_write_cmos_sensor(0x4104, 0x00);  // ramp_preset1_ful_pos_Hi *
HI841_write_cmos_sensor(0x4105, 0xE6);  // ramp_preset1_ful_pos_Lo *

HI841_write_cmos_sensor(0x410A, 0x01);  // ramp_preset2_ful_neg_Hi *
HI841_write_cmos_sensor(0x410B, 0x2E);  // ramp_preset2_ful_neg_Lo *
HI841_write_cmos_sensor(0x4108, 0x03);  // ramp_preset2_ful_pos_Hi *
HI841_write_cmos_sensor(0x4109, 0x98);  // ramp_preset2_ful_pos_Lo *
...
HI841_write_cmos_sensor(0x41D7, 0x9B);  // ramp_dn_2_pos_Lo *
HI841_write_cmos_sensor(0x41D4, 0x00);  // ramp_dn_2_neg_Hi *
HI841_write_cmos_sensor(0x41D5, 0xE6);  // ramp_dn_2_neg_Lo *
...
HI841_write_cmos_sensor(0x41DD, 0x98);  // ramp_dn_4_pos_Lo *
HI841_write_cmos_sensor(0x41DE, 0x02);  // ramp_dn_4_neg_Hi *
HI841_write_cmos_sensor(0x41DF, 0x62);  // ramp_dn_4_neg_Lo *

HI841_write_cmos_sensor(0x41E8, 0x00);  // ramp_lsb2c_1_pos_Hi *
HI841_write_cmos_sensor(0x41E9, 0x9B);  // ramp_lsb2c_1_pos_Lo *
HI841_write_cmos_sensor(0x41EA, 0x00);  // ramp_lsb2c_1_neg_Hi *
HI841_write_cmos_sensor(0x41EB, 0xE6);  // ramp_lsb2c_1_neg_Lo *

HI841_write_cmos_sensor(0x41EC, 0x02);  // ramp_lsb2c_2_pos_Hi *
HI841_write_cmos_sensor(0x41ED, 0x62);  // ramp_lsb2c_2_pos_Lo *
HI841_write_cmos_sensor(0x41EE, 0x03);  // ramp_lsb2c_2_neg_Hi *
HI841_write_cmos_sensor(0x41EF, 0x98);  // ramp_lsb2c_2_neg_Lo *
...
HI841_write_cmos_sensor(0x41B3, 0x3E);  // col_init_neg_Lo *
...
HI841_write_cmos_sensor(0x4141, 0x28);  // int_addr_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x4145, 0x26);  // int_en_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x414D, 0x22);  // int_rx1_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x4159, 0x1E);  // int_tx1_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x4161, 0xA0);  // scn_addr_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x4169, 0x9C);  // scn_en_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x416D, 0x98);  // scn_sx_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x417D, 0x0E);  // scn_rx1_ful_neg_Lo *

HI841_write_cmos_sensor(0x4182, 0x03);  // scn_rx3_ful_pos_Hi *
HI841_write_cmos_sensor(0x4183, 0x9A);  // scn_rx3_ful_pos_Lo *
HI841_write_cmos_sensor(0x4184, 0x03);  // scn_rx3_ful_neg_Hi *
HI841_write_cmos_sensor(0x4185, 0x9E);  // scn_rx3_ful_neg_Lo *

HI841_write_cmos_sensor(0x416E, 0x00);  // scn_tx1_ful_pos_Hi *
HI841_write_cmos_sensor(0x416F, 0xE6);  // scn_tx1_ful_pos_Lo *
HI841_write_cmos_sensor(0x4170, 0x00);  // scn_tx1_ful_neg_Hi *
HI841_write_cmos_sensor(0x4171, 0xF2);  // scn_tx1_ful_neg_Lo *

HI841_write_cmos_sensor(0x4176, 0x03);  // scn_tx3_ful_pos_Hi *
HI841_write_cmos_sensor(0x4177, 0x9A);  // scn_tx3_ful_pos_Lo *
HI841_write_cmos_sensor(0x4178, 0x03);  // scn_tx3_ful_neg_Hi *
HI841_write_cmos_sensor(0x4179, 0x9E);  // scn_tx3_ful_neg_Lo *

HI841_write_cmos_sensor(0x418A, 0x00);  // cds_rst_ful_pos_Hi
HI841_write_cmos_sensor(0x418B, 0x08);  // cds_rst_ful_pos_Lo
HI841_write_cmos_sensor(0x418C, 0x00);  // cds_rst_ful_neg_Hi *
HI841_write_cmos_sensor(0x418D, 0xE6);  // cds_rst_ful_neg_Lo *

HI841_write_cmos_sensor(0x418E, 0x00);  // cds_sig_ful_pos_Hi *
HI841_write_cmos_sensor(0x418F, 0xEC);  // cds_sig_ful_pos_Lo *
HI841_write_cmos_sensor(0x4190, 0x03);  // cds_sig_ful_neg_Hi *
HI841_write_cmos_sensor(0x4191, 0xA2);  // cds_sig_ful_neg_Lo *

HI841_write_cmos_sensor(0x4192, 0x00);  // cds_s1_1_pos_Hi *
HI841_write_cmos_sensor(0x4193, 0x10);  // cds_s1_1_pos_Lo *
HI841_write_cmos_sensor(0x4194, 0x00);  // cds_s1_1_neg_Hi *
HI841_write_cmos_sensor(0x4195, 0x3E);  // cds_s1_1_neg_Lo *

HI841_write_cmos_sensor(0x41AA, 0x00);  // cds_s1_2_pos_Hi *
HI841_write_cmos_sensor(0x41AB, 0xF4);  // cds_s1_2_pos_Lo *
HI841_write_cmos_sensor(0x41AC, 0x01);  // cds_s1_2_neg_Hi *
HI841_write_cmos_sensor(0x41AD, 0x2C);  // cds_s1_2_neg_Lo *

HI841_write_cmos_sensor(0x4196, 0x00);  // cds_s2_ful_pos_Hi *
HI841_write_cmos_sensor(0x4197, 0x10);  // cds_s2_ful_pos_Lo *  ////////
HI841_write_cmos_sensor(0x4198, 0x00);  // cds_s2_ful_neg_Hi *
HI841_write_cmos_sensor(0x4199, 0x38);  // cds_s2_ful_neg_Lo *  ////////

HI841_write_cmos_sensor(0x419A, 0x00);  // cds_s3_ful_pos_Hi *
HI841_write_cmos_sensor(0x419B, 0x10);  // cds_s3_ful_pos_Lo *  ////////
HI841_write_cmos_sensor(0x419C, 0x00);  // cds_s3_ful_neg_Hi *
HI841_write_cmos_sensor(0x419D, 0x3D);  // cds_s3_ful_neg_Lo *  ////////

HI841_write_cmos_sensor(0x4186, 0x00);  // cds_rst_clp_ful_pos_Hi *
HI841_write_cmos_sensor(0x4187, 0x0F);  // cds_rst_clp_ful_pos_Lo *
HI841_write_cmos_sensor(0x4188, 0x00);  // cds_rst_clp_ful_neg_Hi *
HI841_write_cmos_sensor(0x4189, 0x3E);  // cds_rst_clp_ful_neg_Lo *

HI841_write_cmos_sensor(0x419E, 0x00);  // cds_s4_ful_pos_Hi *
HI841_write_cmos_sensor(0x419F, 0x46);  // cds_s4_ful_pos_Lo *
HI841_write_cmos_sensor(0x41A0, 0x03);  // cds_s4_ful_neg_Hi *
HI841_write_cmos_sensor(0x41A1, 0xA2);  // cds_s4_ful_neg_Lo *
...
HI841_write_cmos_sensor(0x41B5, 0x98);  // col_load_ful_pos_Lo *
HI841_write_cmos_sensor(0x41B6, 0x03);  // col_load_ful_neg_Hi *
HI841_write_cmos_sensor(0x41B7, 0xA0);  // col_load_ful_neg_Lo *
///////////////////////////////////////////
...
HI841_write_cmos_sensor(0x0100, 0x01);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	HI841SetFlipMirror(IMAGE_V_MIRROR);
