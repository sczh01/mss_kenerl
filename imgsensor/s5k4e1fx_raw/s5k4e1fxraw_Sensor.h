...
typedef struct
{
	...
	kal_int16 imgMirror;
	kal_bool  S5K4E1FXAutoFlickerMode;
	...
	#define S5K4E1FX_IMAGE_SENSOR_VIDEO_WIDTH					S5K4E1FX_IMAGE_SENSOR_PV_WIDTH
	#define S5K4E1FX_IMAGE_SENSOR_VIDEO_HEIGHT					S5K4E1FX_IMAGE_SENSOR_PV_HEIGHT
	...
	#define S5K4E1FX_FULL_X_START						    		(2+1)
	#define S5K4E1FX_FULL_Y_START						    		(3)
	#define S5K4E1FX_FULL_X_END						        		2607 //2601
	#define S5K4E1FX_FULL_Y_END						        		1959 //1953
	#define S5K4E1FX_PV_X_START						    			(2+1)
	#define S5K4E1FX_PV_Y_START						    			(3)
	...
	#define S5K4E1FX_FULL_PERIOD_PIXEL_NUMS					0x0B5C //0x0B5C=2908      0x0AB2=2738
	#define S5K4E1FX_FULL_PERIOD_LINE_NUMS					0x07B4  //1972
	
	#define S5K4E1FX_PV_PERIOD_PIXEL_NUMS					0x0B5C //0x0B5C=2908      0x0AB2=2738
...
#define S5K4E1FX_WRITE_ID 	(0x20)	//(0x20)   //(0x6E)
#define S5K4E1FX_READ_ID	(0x21)
...
#define S5K4E1FX_PAGE_SETTING_REG    (0xFF)
...
UINT32 S5K4E1FXGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 S5K4E1FXControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 S5K4E1FXFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
