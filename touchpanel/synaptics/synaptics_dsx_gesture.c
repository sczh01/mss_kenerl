...
extern int synaptics_rmi4_i2c_read(struct synaptics_rmi4_data *rmi4_data,
		unsigned short addr, unsigned char *data,
		unsigned short length);
extern int synaptics_rmi4_i2c_write(struct synaptics_rmi4_data *rmi4_data,
		unsigned short addr, unsigned char *data,
		unsigned short length);
extern int tpd_halt;
#define GESTURE_PHYS_NAME "synaptics_dsx/gesture"
#define GESTURE_DRIVER_NAME GESTURE_PHYS_NAME 
